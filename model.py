...
class Model:
    def __init__(self, x, y_labels):
        ...
        self.in_dim = int(x.get_shape()[1]) # input dimension - 784 (28 * 28) for MNIST
        self.out_dim = int(y_labels.get_shape()[1]) # output dimension - 10 classes (digits 0-9) for MNIST
