...
def parse_arguments():
    ...
    if args.experiment == 'mnist':
        ...
        args.dataset = 'mnist'
        args.tasks = 100
        args.output_file = 'EWC_non_expandable_mlp_pen_fix_run{}'.format(args.run) 
        args.nets = ['EWCMLP']
        ...
        args.dataset = 'cifar'
        args.tasks = 20
        args.output_file = 'nonexpanding_increm_cifar_modded_thresh_{}_lam_{}_all_fil_{}_256_cw_scale_2_bs_1'.format(args.accuracy_threshold, args.lam, args.hidden_size)
