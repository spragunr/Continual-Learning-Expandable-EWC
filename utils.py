...
def generate_new_mnist_task(train_dataset_size, validation_dataset_size, kwargs):
    ...
    new_train_data, new_validation_data = D.dataset.random_split(
    ...
    train_loader = D.DataLoader(new_train_data, batch_size=args.batch_size, shuffle=True, **kwargs)
